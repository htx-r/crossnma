...
crossnma.league(jagsfit2, exp = TRUE, prt.cov1.value = 38)
```
...
```{r, fig.width=6, fig.height=5,fig.show='hold',fig.align='center'}
crossnma.heatplot(jagsfit3, exp = TRUE, prt.cov1.value = 38,
                  cell.text.size=6,trt.name.size=20,axis.title.size=12)
```
