...
#' practice and bridges the efficacy-effectiveness gap. The cross-NMA/NMR model
#' is a Bayesian suite for evidence synthesis which extends and integrates
#' four different approaches that combine RCT and NRS evidence into a three-level
...
#' Further details:
#' \itemize{
#' \item To have a list of all R functions available in \bold{crossnma} type \code{help(package = "crossnma")}
#'
#' \item The R command \code{citation("crossnma")} shows how to cite \bold{crossnma} in
#' publications.
#'
#' \item To report problems and bugs
#' send an email to \email{tasnim.hamza@@ispm.unibe.ch}
#'
#' \item The development version of \bold{crossnma} is available on GitHub
...
#' Mixed treatment comparisons using aggregate and individual participant level data. \emph{Stat Med}.
#' \bold{10;31(28)}, 3516–36.
#' Dias, Sofia, N. J. Welton, V. C. C. Marinho, G. Salanti, J.P.T Higgins, and A. E. Ades (2010):
...
#' \emph{Cochrane Database of Systematic Reviews, no. 9.} John Wiley & Sons, Ltd. https://doi.org/10.1002/14651858.CD011381.pub2.
#'
#' Verde, Pablo Emilio. (2020):
#' A Bias-Corrected Meta-Analysis Model for Combining, Studies of Different Types and Quality.
#' \emph{Biometrical Journal. Biometrische Zeitschrift},
#' \url{https://doi.org/10.1002/bimj.201900376.}
#'
#' @keywords package
#'
#' @importFrom magrittr %>%
