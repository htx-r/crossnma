...
#'@description This function creates posterior summary statistics for the fitted cross NMA/NMR model
#'@param x A crossrun object generated by the \code{\link{crossnma.run}} function.
...
#'@param exp A logical value indicating whether to exponentiate the parameters of relative treatment effect and covariate effect. Default is TRUE.
#'@param ... Additional arguments to be passed to summary() function
#'@return \code{crossnma.summary} returns a matrix containing the following summary statistics (in columns) for each estimated parameter:
...
crossnma.summary <- function(x, digits = 3,  quantiles = c(0.025, 0.5, 0.975), exp=TRUE, ...)
{
  # initial
